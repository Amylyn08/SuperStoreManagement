...
CREATE TABLE Warehouses_Stores(
    warehouseID NUMBER(2)   REFERENCES Warehouses(warehouseID) NOT NULL,
    storeID     NUMBER(2)   REFERENCES Stores(storeID) NOT NULL
);
...
CREATE TABLE Warehouses_Products(
    warehouseID     NUMBER(2)   REFERENCES Warehouses(warehouseID) NOT NULL,
    productID       NUMBER(2)   REFERENCES Products(productID) NOT NULL,
...
CREATE TABLE Orders(
    ...
    customerID      NUMBER(2)   REFERENCES Customers(customerID) NOT NULL,
    storeID         NUMBER(2)   REFERENCES Stores(storeID) NOT NULL,
    orderDate       DATE
);

CREATE TABLE Orders_Products(
    orderID         NUMBER(2)   REFERENCES Orders(orderID) NOT NULL,
    productID       NUMBER(2)   REFERENCES Products(productID) NOT NULL,
...
INSERT INTO Warehouses (warehouseID, name, streetAddress, city, province, country) 
VALUES (2, 'Warehouse B', '304 Rue François-Perrault', 'Villeray Saint-Michel', 'Quebec', 'Canada');
INSERT INTO Warehouses (warehouseID, name, streetAddress, city, province, country) 
...
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (1, 'mahsa', 'sadeghi', 'msadeghi@dawsoncollege.qc.ca', 'Dawson College', 'Montreal', 'Quebec', 'Canada', 'mahsa123');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (2, 'alex', 'brown', 'alex@gmail.com', '090 boul saint laurent', 'Montreal', 'Quebec', 'Canada', 'ilovegertrude');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (3, 'martin', 'alexandre', 'marting@yahoo.com', NULL, 'Brossard', 'Quebec', 'Canada', 'ilikecatsmeow');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (4, 'daneil', 'hanne', 'daneil@yahoo.com', '100 Atwater Street', 'Toronto', 'Ontario', 'Canada', 'cowsgomoo');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (5, 'martin', 'alexandre', 'marting@yahoo.com', NULL, 'Brossard', 'Quebec', 'Canada', 'ihaveabasicname');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (6, 'John', 'boura', 'bdoura@gmail.com', '100 Young Street', 'Toronto', 'Ontario', 'Canada', 'password69');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (7, 'Ari', 'brown', 'b.a@gmail.com', NULL, NULL, NULL, NULL, 'password420');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (8, 'Amanda', 'Harry', 'am.harry@yahoo.com', '100 boul saint laurent', 'Montreal', 'Quebec', 'Canada', 'itsalwayshappyhoursomewhere');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (9, 'Jack', 'Johnson', 'johnson.a@gmail.com', NULL, 'Calgary', 'Alberta', 'Canada', 'jack01234');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (10, 'John', 'belle', 'abcd@yahoo.com', '105 Young Street', 'Toronto', 'Ontario', 'Canada', 'uranu$!');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (11, 'martin', 'Li', 'm.li@gmail.com', '87 boul saint laurent', 'Montreal', 'Quebec', 'Canada', 'my@$$');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (12, 'olivia', 'smith', 'smith@hotmail.com', '76 boul decalthon', 'Laval', 'Quebec', 'Canada', 'google.com');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (13, 'Noah', 'Garcia', 'g.noah@yahoo.com', '22222 Happy Street', 'Laval', 'Quebec', 'Canada', 'mrbeast4ever');
INSERT INTO Customers (customerID, firstName, lastName, email, streetAddress, city, province, country, password) 
VALUES (14, 'mahsa', 'sadeghi', 'ms@gmail.com', '104 Gill Street', 'Toronto', 'Ontario', 'Canada', 'mahsa3456');
...
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
...
VALUES (1, 0, NULL, 5, 5);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 0, 'Did not worth the price', 6, 6);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 0, 'Missing some parts', 7, 7);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (5, 1, 'Trash', 8, 8);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (2, NULL, NULL, 9, 9);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (5, NULL, NULL, 10, 10);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (4, NULL, NULL, 11, 11);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (3, NULL, NULL, 12, 6);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 0, 'Missing some parts', 13, 12);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (4, NULL, NULL, 14, 11);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 0, 'Great product', 15, 12);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (5, 1, 'Bad quality', 16, 8);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 0, NULL, 17, 3);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (4, 0, NULL, 18, 5);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (4, NULL, NULL, 19, 13);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (5, NULL, NULL, 20, 15);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (1, 2, 'Worse car I have driven!', 21, 7);
INSERT INTO Reviews (star, flagNums, description, reviewID, productID)
VALUES (4, NULL, NULL, 22, 15);
